...
const MainMenu = ({
  ...
  return (
    <>
      {isCollapsed ? (
        <div
          className="absolute z-10 w-full h-full md:w-96 
									right-0 top-0
        ...
        >
                  ...
                  <div className="flex items-center font-mono gap-2">
                    <div className="w-12 h-12">
                      <img
                        ...
                        src={`${process.env.REACT_APP_SPACES_URL}/${markURL}`}
                        alt="usermark"
                      />
                    </div>
                    {username}
          ...
          <div
            className="w-full h-full flex flex-col items-center justify-center text-5xl regular
										gap-8"
          >
