...
func TestModuleModel(t *testing.T) {
	...
	t.Run("Test create cluster", func(t *testing.T) {
		...
		result, err := models.CreateModule(&cluster)
		require.Nil(t, err)
	...
	t.Run("Test get cluster", func(t *testing.T) {
		coll, err := models.GetModule(clusterID, userID)
		require.Nil(t, err)
	...
	t.Run("Test get cluster by slug", func(t *testing.T) {
		coll, err := models.GetModuleBySlug(clusterSlug, userID)
		require.Nil(t, err)
		assert.Equal(t, coll.UUID, clusterID)
		assert.Equal(t, clusterName, coll.Name)
	})
	...
	t.Run("Test get non-existing cluster", func(t *testing.T) {
		res, err := models.GetModule(clusterUnknownID, userID)
		assert.NotNil(t, err)
	...
	t.Run("Test update cluster", func(t *testing.T) {
		...
		updated, err := models.UpdateModule(clusterID, userID, &coll)
	...
	t.Run("Test update non-existing cluster", func(t *testing.T) {
		...
		updated, err := models.UpdateModule(clusterUnknownID, userID, &coll)
		assert.NotNil(t, err)
		assert.True(t, updated.CreatedAt.IsZero())
	})

	t.Run("Test delete cluster", func(t *testing.T) {
		coll, err := models.DeleteModule(clusterDeleteID, userID)
